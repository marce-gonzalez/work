...
function render() {
  ...
  rendered.forEach((fire, index) => {
    ...
    const icon = L.divIcon({
      ...
      html: `<div class="smoke-marker ${fire.confidenceLevel} ${fire.isNight ? "is-night" : ""}" style="--size:${size}px;--delay:${delay}s;--rotation:${rotation}deg"><img class="smoke-core" src="./assets/images/smoke-oil.png" alt=""><img class="smoke-puff puff-a" src="./assets/images/smoke-oil.png" alt=""><img class="smoke-puff puff-b" src="./assets/images/smoke-oil.png" alt=""></div>`,
    });
